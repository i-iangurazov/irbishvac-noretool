...
const envSchema = z.object({
  ...
  RIPPLING_API_TOKEN: z.string().optional().default(""),
  RIPPLING_API_VERSION: z.string().regex(/^\d{4}-\d{2}-\d{2}$/).optional().default("2024-08-01"),
  RIPPLING_SYNC_INTERVAL_MINUTES: z.coerce.number().int().min(15).max(720).optional().default(60),
  RIPPLING_MAX_STALE_HOURS: z.coerce.number().int().min(12).max(72).optional().default(24),
  KITCHEN_NEWS_JSON: z.string().optional().default("[]"),
  ...
  ST_REPORT_FIELD_PRO_TECHNICIAN_ACTIVITY: z.string().optional().default("125959497"),
  ST_REPORT_FIELD_PRO_JOB_RECORDINGS: z.string().optional().default("125959432"),
  ...
  GOOGLE_LSA_MANAGER_CUSTOMER_ID: z.string().optional().default(""),
  GOOGLE_LSA_CUSTOMER_ID: z.string().optional().default(""),
  ...
  META_AD_ACCOUNT_IDS: z.string().optional().default(""),
