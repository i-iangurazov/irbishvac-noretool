  ...
  return (
      ...
      headerContent={
        <div className="flex flex-wrap items-center justify-end gap-2">
          <FilterBar
            ...
            presets={[
              { label: "YTD", href: `${props.path}?preset=ytd`, active: props.filters.preset === "ytd" },
              { label: "MTD", href: `${props.path}?preset=mtd`, active: props.filters.preset === "mtd" }
            ]}
          />
    ...
    >
      <div className="flex flex-col gap-3">
        {hasCachedData ? (
          <div className="grid items-start gap-3 xl:grid-cols-[minmax(18rem,0.44fr)_minmax(0,1.56fr)]">
            {featuredItem ? (
              <LeaderboardCard
                featured={true}
            ...
            <section className="grid auto-rows-fr items-stretch gap-3 md:grid-cols-2 xl:grid-cols-4">
