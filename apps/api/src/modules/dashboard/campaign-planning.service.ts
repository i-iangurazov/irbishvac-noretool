...
type PlanInput = {
  ...
  month: string;
  channel: string;
  category: "paid" | "separate-spend" | "organic" | "automation" | "retention" | "partner" | "other";
  ...
  async saveInput(raw: CampaignPlanningInput) {
    ...
    try {
      ...
      if (type === "plan") {
        ...
        if (!["paid", "separate-spend", "organic", "automation", "retention", "partner", "other"].includes(category)) {
