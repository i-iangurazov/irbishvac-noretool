<Screen
  ...
  urlSlug="page7"
  uuid="cf3fcb81-d7a8-4d12-9bd4-74340881024c"
>
  <SqlQueryUnified
    id="getCSR3"
    ...
    query={include("../lib/getCSR3.sql", "string")}
  ...
  <RESTQuery
    id="getCSRData3"
    body={
      '{\n  "parameters": [\n    { "name": "From", "value": "{{ date16.value && new Date(date16.value).toISOString().slice(0,10) }}" },\n    { "name": "To", "value": "{{ date15.value && new Date(date15.value).toISOString().slice(0,10) }}" },\n    { "name": "IncludeInactive", "value": "false" }\n  ]\n}'
    }
    bodyType="raw"
    enableTransformer={true}
    headers={
      '[{"key":"Content-Type","value":"application/json"},{"key":"ST-App-Key","value":"ak1.w4l5o1oh0suj888aeb4mkirux"},{"key":"Authorization","value":"Bearer {{ getToken7.data.access_token }}"}]'
    }
    isMultiplayerEdited={false}
  ...
  (() => {
    ...
    >
      ...
      <Event
        id="51b74053"
        enabled="{{ !!getToken7.data.access_token }}"
        event="click"
        method="trigger"
        params={{}}
        pluginId="getCSRData3"
        type="datasource"
        waitMs="1000"
        waitType="debounce"
      />
  ...
  (() => {
    ...
    <HTML id="html11" html={include("../lib/html11.html", "string")} />
  </Frame>
</Screen>
