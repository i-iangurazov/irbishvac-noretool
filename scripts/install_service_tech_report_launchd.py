...
LABEL = "com.irbis.service-tech-reports"


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Install the local macOS guard that runs the Thursday report delivery job."
    )
    ...
    payload = {
        ...
        "ProgramArguments": [
            sys.executable,
            str(repo / "scripts" / "run_service_tech_thursday_delivery.py"),
            "--mode",
            "send",
        ],
        ...
        "StandardOutPath": str(log_dir / "service-tech-reports.log"),
        "StandardErrorPath": str(log_dir / "service-tech-reports.error.log"),
    }
